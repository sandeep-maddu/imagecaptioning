...
def test(test_feat='./guitar_player.npy', model_path='./models/model-72', maxlen=30): # Naive greedy search
...
def test_tf(test_image_path='./test10.jpg', model_path1='./models/model-9999', maxlen=30):
    ...
    #tf.reset_default_graph()
    #saver.restore(sess, model_path)
    saver.restore(sess, './models/model-9999')
