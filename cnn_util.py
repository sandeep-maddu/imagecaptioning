...
def crop_image(x, target_height=227, target_width=227, as_float=True):
	#if x is None : image =[[0,0,0,0]]
    #image = skimage.img_as_float(skimage.io.imread(x)).astype(np.float32)
	
	#in case it fails to return proper, make sure that this is the right shape [[ ]] and ***not*** []
...
deploy = '/home/ubuntu/src/caffe/models/vgg/VGG_ILSVRC_19_layers_deploy.prototxt'
model = '/home/ubuntu/src/caffe/models/vgg/VGG_ILSVRC_19_layers.caffemodel'
mean = '/home/ubuntu/src/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
